  ...
  function configureStates($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
      ...
      .state('bookmarks.list', {
        ...
        views: {
          'content@bookmarks': {
            templateUrl   : 'app/modules/useCases/bookmarks/templates/list.html',
      ...
      .state('bookmarks.search', {
        ...
        views: {
          'content@bookmarks': {
            templateUrl   : 'app/modules/useCases/bookmarks/templates/search.html',
      ...
      .state('bookmarks.new', {
        ...
        views: {
          'content@bookmarks': {
            templateUrl   : 'app/modules/useCases/bookmarks/templates/form.html',
