define(function(require) {
  ...
  ResolutionsFactory.$inject = [
    'ResolutionsResource', '$location', 'ResolutionsSearchResource', 'ResolutionsPaginationResource'
  ];

  function ResolutionsFactory(resource, $location, resourceSearch, resourcePagination) {
