define(function(require) {
  ...
  module.controller('CitiesListCtrl', CitiesListCtrl);
  CitiesListCtrl.$inject = ['$state', 'PaginationFactory', 'CitiesSearchResource', 'CitiesFactory'];

  function CitiesListCtrl($state, pagination, ResourceSearch, dataService) {
    var vm = this;
    init();
    ...
    vm.path = function(id) {
      if (id > 0) {
        $state.go('home.cities.edit', {id: id});
      } else {
        $state.go('home.cities.new');        
      }
    }
