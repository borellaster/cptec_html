define(function(require) {
  ...
  module.controller('CouplesListCtrl', CouplesListCtrl);
  CouplesListCtrl.$inject = ['$state', 'PaginationFactory', 'CouplesSearchResource', 'CouplesFactory'];

  function CouplesListCtrl($state, pagination, ResourceSearch, dataService) {
    var vm = this;
    init();
    ...
    vm.path = function(id) {
      if (id > 0) {
        $state.go('home.couples.edit', {id: id});
      } else {
        $state.go('home.couples.new');        
      }
    }
