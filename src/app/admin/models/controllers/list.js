define(function(require) {
  ...
  module.controller('ModelsListCtrl', ModelsListCtrl);
  ModelsListCtrl.$inject = ['$state', 'PaginationFactory', 'ModelsSearchResource', 'ModelsFactory'];

  function ModelsListCtrl($state, pagination, ResourceSearch, dataService) {
    var vm = this;
    init();
    ...
    vm.path = function(id) {
      if (id > 0) {
        $state.go('home.models.edit', {id: id});
      } else {
        $state.go('home.models.new');        
      }
    }
