  ...
  this.render = function() {
    if ( ngModelCtrl.$viewValue ) {
      if ( Object.prototype.toString.call(ngModelCtrl.$viewValue) === "[object Date]" ) {
        if ( isNaN( ngModelCtrl.$viewValue.getTime() ) ) {
          var date = new Date(moment(ngModelCtrl.$viewValue).format('MM/DD/YYYY'));
        }
        else {
          var date = new Date(moment(ngModelCtrl.$viewValue).format('MM/DD/YYYY'));
        }
        ...
        var dia = ngModelCtrl.$viewValue.substr(0,2),
        mes = ngModelCtrl.$viewValue.substr(3,2),
        ano = ngModelCtrl.$viewValue.substr(6,4),
        data = mes + '/' + dia + '/' + ano,
        date = new Date(data);
      }
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    "<ul class=\"dropdown-menu datepicker-pba\" ng-if=\"isOpen\" style=\"display: block\" ng-style=\"{top: position.top+'px', left: position.left+'px'}\" ng-keydown=\"keydown($event)\" ng-click=\"$event.stopPropagation()\">\n" +
    "	<li ng-transclude></li>\n" +
...
angular.module("template/timepicker/timepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/timepicker/timepicker.html",
    ...
    "      <td><a ng-click=\"incrementHours()\" class=\"btn btn-link\"><span class=\"fa fa-angle-up\"></span></a></td>\n" +
    "      <td>&nbsp;</td>\n" +
    "      <td><a ng-click=\"incrementMinutes()\" class=\"btn btn-link\"><span class=\"fa fa-angle-up\"></span></a></td>\n" +
    ...
    "    </tr>\n" +
    "    <tr class=\"text-center\" ng-show=\"::showSpinners\">\n" +
    "      <td><a ng-click=\"decrementHours()\" class=\"btn btn-link\"><span class=\"fa fa-angle-down\"></span></a></td>\n" +
    "      <td>&nbsp;</td>\n" +
    "      <td><a ng-click=\"decrementMinutes()\" class=\"btn btn-link\"><span class=\"fa fa-angle-down\"></span></a></td>\n" +
    "      <td ng-show=\"showMeridian\"></td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
